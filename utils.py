...
def check_mnist_dataset_exists(path_data='./Learning_Data/'):
...
def check_fashion_mnist_dataset_exists(path_data='./Learning_Data/'):
    flag_train_data = os.path.isfile(path_data + 'fashion-mnist/train_data.pt')
    flag_train_label = os.path.isfile(
        path_data + 'fashion-mnist/train_label.pt')
...
def check_cifar_dataset_exists(path_data='./Learning_Data/'):
